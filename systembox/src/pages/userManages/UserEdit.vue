      ...
      >
        ...
        <el-form-item>
          <el-button
            ...
            >取 消</el-button
          >
          <el-button type="primary" @click="editData('editInfo')"
            >保存</el-button
          >
        </el-form-item>
      </el-form>
...
export default {
  data() {
    return {
      ...
      updateUserListUrl: this.$store.state.url + "backend/user/update",
      rules: {
        nickName: [
          {
            pattern: /^[\u0391-\uFFE5]{2,10}$/,
    ...
    editData(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          console.log(pamars);
          this.$axios.put(this.updateUserListUrl, pamars).then((res) => {
